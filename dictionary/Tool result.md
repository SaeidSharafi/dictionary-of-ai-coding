...
نتیجه تا پایان [نشست](./Session.md) در زمینه می‌ماند. نتیجه ابزار‌ها معمولاً بخش اعظم زمینه یک نشست کدنویسی‌اند: هر فایل خوانده‌شده، هر اجرای تست، هر جست‌وجو کامل وارد می‌شود و مدت زیادی بعد از اینکه دیگر مفید ن‌بود [توکن‌ها](./Token.md) را اشغال می‌کند. چند نتیجه بزرگ — یک لاگ تست پرحرف، یک فایل تولیدشده که کامل خوانده شده — می‌توانند نشست را سریع‌تر از خود گفت‌وگو به لبه [پنجره زمینه](./Context%20window.md) ب‌رسانند.
