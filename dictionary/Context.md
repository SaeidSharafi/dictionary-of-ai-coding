...
بیشتر شکست‌های روزمره به زمینه برمی‌گردد. وقتی عامل یک API را از خودش می‌سازد، با یک تصمیم تناقض می‌گوید، یا سر یک شِما حدس می‌زند، اولین پرسش این است که هنگام این کار چه چیزی در زمینه بوده — معمولاً واقعیت مربوط هرگز بارگذاری ن‌شده، یا زیر [افت توجه](./Attention%20degradation.md) دفن شده. راه‌حل گزینش است: چیزی را بار کنید که کار لازم دارد و آنچه را که لازم ندارد بیرون نگه دارید.
