...
| لایه        | وضعیت‌دار؟  | چطور                                                                                                                                        |
| ----------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| مدل         | هرگز        | [پارامتر‌ها](./Parameters.md) منجمدند؛ فقط آنچه در هر درخواست است را می‌بیند                                                                |
| نشست        | بین نوبت‌ها | بستر اجرایی هر پیام و [نتیجه ابزار](./Tool%20result.md) را به زمینه اضافه می‌کند                                                            |
| بستر اجرایی | بین نشست‌ها | فایل‌های حافظه، [AGENTS.md](./AGENTS.md.md)، [سند‌های انتقال زمینه](./Handoff%20artifact.md) — نوشته می‌شوند، بعداً دوباره بارگذاری می‌شوند |
